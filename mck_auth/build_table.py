...
def build_category_table(request):
    ...
    try:
        ...
        table_data['load_url'] = reverse('mck_website:mck_category_list')
        table_data['create_url'] = reverse('mck_website:mck_category_create')
        table_data['delete_url'] = reverse('mck_website:mck_category_delete', args=[0])
...
def build_product_table(request):
    ...
    try:
        ...
        table_data['load_url'] = reverse('mck_website:mck_product_list')
        table_data['create_url'] = reverse('mck_website:mck_product_create')
        table_data['delete_url'] = reverse('mck_website:mck_product_delete', args=[0])
        
        table_data["columns"] = []
        table_data["columns"].append(dict(
            display_name="Category", can_show=True,
            class_name="", column_name="category",
            search_key="category"
        ))
        table_data["columns"].append(dict(
            display_name="Name", can_show=True,
        ...
        table_data["columns"].append(dict(
            display_name="SKU", can_show=True,
            class_name="", column_name="sku",
            search_key="sku"
        ))
        table_data["columns"].append(dict(
            display_name="Price", can_show=True,
            class_name="", column_name="price",
            search_key="price"
        ))
        table_data["columns"].append(dict(
            display_name="Stock", can_show=True,
            class_name="", column_name="stock",
            search_key="stock"
        ))
        table_data["columns"].append(dict(
            display_name="Status", can_show=True,
...
def build_cart_table(request):
    ...
    try:
        ...
        table_data["columns"] = []
        table_data["columns"].append(dict(
            display_name="User", can_show=True,
            class_name="", column_name="user",
            search_key="user__username"
        ))
        table_data["columns"].append(dict(
            display_name="Items", can_show=True,
...
def build_order_table(request):
    ...
    try:
        ...
        table_data['create_url'] = reverse('mck_website:mck_order_create')
        ...
        table_data["columns"].append(dict(
            ...
            class_name="text-end", column_name="total_amount",
            search_key="total_amount"
        ))
        table_data["columns"].append(dict(
            display_name="Status", can_show=True,
            class_name="text-center", column_name="datamode",
            search_key="datamode"
        ))
    except Exception as e:
        exc_type, exc_obj, exc_traceback = sys.exc_info()
...
@app_logger.functionlogs(log=LOG_NAME)
def build_order_item_table(request, order_id=None):
    table_data = dict()
    try:
        table_data['title'] = "Order Items"
        table_data['sub_title'] = "Order Items Management"
        
        if order_id:
            table_data['load_url'] = reverse('mck_website:mck_order_item_list', args=[order_id])
            table_data['create_url'] = reverse('mck_website:mck_order_item_create_with_order', args=[order_id])
        else:
            table_data['load_url'] = reverse('mck_website:mck_order_item_list_all')
            table_data['create_url'] = reverse('mck_website:mck_order_item_create')
            
        table_data['delete_url'] = reverse('mck_website:mck_order_item_delete', args=[0])
        
        table_data["columns"] = []
        table_data["columns"].append(dict(
            display_name="Product", can_show=True,
            class_name="", column_name="product_name",
            search_key="product_name"
        ))
        table_data["columns"].append(dict(
            display_name="Unit Price", can_show=True,
            class_name="text-end", column_name="unit_price",
            search_key="unit_price"
        ))
        table_data["columns"].append(dict(
            display_name="Quantity", can_show=True,
            class_name="text-center", column_name="quantity",
            search_key="quantity"
        ))
        table_data["columns"].append(dict(
            display_name="Total", can_show=True,
            class_name="text-end", column_name="total_price",
            search_key="total_price"
        ))
        if not order_id:
            table_data["columns"].append(dict(
                display_name="Order", can_show=True,
                class_name="", column_name="order",
                search_key="order__order_number"
            ))
        table_data["columns"].append(dict(
            display_name="Status", can_show=True,
            class_name="text-center", column_name="datamode",
...
@app_logger.functionlogs(log=LOG_NAME)
def build_user_table(request):
    table_data = dict()
    try:
        table_data['title'] = "Users"
        table_data['sub_title'] = "User Management"
        table_data['load_url'] = reverse('mck_website:mck_user_list')
        table_data['create_url'] = reverse('mck_website:mck_user_create')
        table_data['delete_url'] = reverse('mck_website:mck_user_delete', args=[0])
        
        table_data["columns"] = []
        table_data["columns"].append(dict(
            display_name="Username", can_show=True,
            class_name="", column_name="username",
            search_key="username"
        ))
        table_data["columns"].append(dict(
            display_name="First Name", can_show=True,
        ...
        table_data["columns"].append(dict(
            display_name="Joined Date", can_show=True,
            class_name="", column_name="date_joined",
            search_key="date_joined"
        ))
        table_data["columns"].append(dict(
            display_name="Is Active", can_show=True,
            class_name="", column_name="is_active",
            search_key="is_active"
        ))
        table_data["columns"].append(dict(
